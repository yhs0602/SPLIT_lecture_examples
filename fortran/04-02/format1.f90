...
! 1234567890123 을 입력할 것
 ...
 ! print *, "아래는 인풋용"
  ...
  print *, ""
! 2x: two spaces /: line feed
! f3.1 : precision point is also counted as number so 3
...
! 7 jari sosu 2
  print "(f7.2)" , a1
  print "(f6.2)" , a1
! print ***** if it cannot print in given space
  print "(f5.2)" , a1
  print "(f8.3)" , a1
  print "(f7.1)" , a1
  print "(f4.1)" , a1
...
!Scientific exponetial
  ...
  print "(es9.3)" , a2
  print "(es10.4)" , a2
! es neun zero ga eopda
! -do 1jari chargehanda
  print "(i4)" , b1
  print "(i5)" , b1
  print "(i3,/)" , b1
  print "(i4)" , b2
  ...
  print "(i3)" , b3
  print "(i0)" , b3
! to make 7 jari fill 0s (total use 8 space)
  print "(i8.7)" ,b3
!ignore second and add newline
  print "(i4 i4)" ,b3
! print one two and add newline then print three
